...
# --- Room & Environment ---
T_AMBIENT = 0.0        # Outside temperature (deg C), typical UK winter
...
# --- Heater ---
U_MAX = 5.0           # Maximum heating rate (deg C/min equivalent, normalised)
...
ALPHA = 0.03            # Thermal diffusivity (m^2/min), for spatial models
